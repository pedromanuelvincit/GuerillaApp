document.addEventListener('DOMContentLoaded', () => {
    ...
    async function callGemini(payload, buttonElement) {
        ...
        // Português: IMPORTANTE! É aqui que você deve inserir a sua chave de API do Google Gemini.
        const apiKey = "AIzaSyC3ya8RoOXII-SLh-GOEqNa45mbZTDx0ik"; // <--- COLOQUE A SUA CHAVE DE API AQUI
        // ===============================================================================================
